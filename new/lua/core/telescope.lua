...
local telescope_conf = require "telescope"

local theme = require("telescope.themes")["get_" .. (telescope.theme or "")]
if theme then telescope.defaults = theme(telescope.defaults) end

telescope_conf.setup(telescope)

if telescope.on_config_done then telescope.on_config_done(telescope) end
