...
local function custom_filter(buf, buf_nums)
    local logs = vim.tbl_filter(function(b) return is_ft(b, "log") end,
                                buf_nums or {})
...
M.config = function()
    local bufferline = {
        ...
        options = {
            ...
            umbers = "none", -- can be "none" | "ordinal" | "buffer_id" | "both" | function
