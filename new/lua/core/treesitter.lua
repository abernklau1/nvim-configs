    ...
    treesitter = {
        ...
        highlight = {
            ...
            disable = function(lang, buf)
                ...
                local status_ok, big_file_detected = pcall(vim.api
                                                               .nvim_buf_get_var,
                                                           buf,
...
function M.setup()
    ...
    local opts = vim.deepcopy(treesitter)

    treesitter_configs.setup(opts)

    if treesitter.on_config_done then
        treesitter.on_config_done(treesitter_configs)
    end
